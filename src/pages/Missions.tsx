...
export default function Missions() {
  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden bg-background flex flex-col">
      <div className="absolute bottom-0 right-2 text-[22vw] md:text-[16vw] font-display font-black text-white/[0.04] select-none pointer-events-none leading-none z-0">MISSION</div>
